...
export function f(a, b){return b.length+a*3+1}
    ...
    expect(removeWhites(project.getSourceFile('test.ts')!.getText())).toBe('var a export function f(a: number, b: { length: number; }){return b.length+a*3+1}')
  })
...
export function g<T,G>(a, b){
  ...
  return g*2
    ...
    `) 
applyAllSuggestedCodeFixes(project,project.getSourceFile('test.ts')!, [7043, 7044, 7045, 7046, 7047, 7048, 7049, 7050, 7051])
