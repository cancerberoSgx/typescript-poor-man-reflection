...
describe('registerExtractor', () => {
  const customExtractor = '/home/sg/git/typescript-poor-man-reflection/src/__tests__/cliExperiments/exportedExtractor1.ts'
  afterAll(() => {
  ...
  it('Should be able to register a .ts file exporting an extractor', ()=>{
    const program = `src/__tests__/cliExperiments/cliExperimentTestSample1.ts`
    let r = exec( 
